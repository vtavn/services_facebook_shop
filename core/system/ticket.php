<div class="col-lg-12"> 
          <div class="box box-danger"> 
            <div class="box-header with-border"> 
              <h3 class="box-title">TẠO TICKET - YÊU CẦU HỖ TRỢ KHÁCH HÀNG</h3> 
            </div> 
...
?> 
            <tr> 
              <td>  
                <a href="/index.php?vip=view_ticket&maso=<?php echo $res['maso']; ?>" target="_blank" data-toggle="tooltip" title="Xem Ticket" style="color:black"> 
              ...
              <td> 
<a href="/index.php?vip=ticket&xoa=<?php echo $res['id']; ?>" data-toggle="tooltip" title="Xóa ID" class="btn btn-success btn-simple btn-xs">Xóa</a> 
              </td> 
            </tr> 
            <?php 
} 
