    ...
    <div class="modal-dialog"> 
        <div class="modal-content"> 
            ...
            <div class="modal-body"> 
                        <span class="h4"> 
                            <center><b>NẠP THẺ TỰ ĐỘNG HIỆN KHÔNG NẠP TỰ ĐÔNG ĐƯỢC. VUI LÒNG GỬI MÃ THẺ + SERI + LOẠI CARD CHO ADMIN ĐỂ NẠP! HOẶC NHẮN TIN TRỰC TIẾP ĐẾN 0919.257.664 ĐỂ ĐƯỢC GẶP RIÊNG ADMIN!</b> </br> <b> <a target="_blank" href="https://m.me/100009580369715">FACEBOOK ADMIN DUY NHẤT!</a> !!</b></center> 
                        </span> 
            </div> 
...
<input class="form-control" id="code" name="code" placeholder="Mã thẻ" data-toggle="tooltip" data-title="Mã số sau lớp bạc mỏng"/> 
</div> 
<div class="form-group"> 
<label class="control-label">Số seri <star>*</star></label> 
<input class="form-control" id="serial" name="serial" placeholder="Số seri" data-toggle="tooltip" data-title="Mã seri nằm sau thẻ"/> 
</div> 
