...
function Fly(fid, type, color, sh, sw, x, y, fly_img, name, title) {
	...
	f.addEventListener('mouseover', function() {
		if(!parent.died){
			parent.speedmove();
			if (Math.random() < 0.5) {
				f.style.cursor = 'url("https://static1.fshare.vn/images/flyswatter.png"), pointer';
				$('html').css('cursor','url("https://static1.fshare.vn/images/flyswatter.png"), default');			
				hasswatter = true;
	...
	f.addEventListener('click', function() {	
		if(hasswatter){
			f.style.cursor = 'pointer';			
			f.style.backgroundImage = "url(https://static1.fshare.vn/images/fly-swattered.png)";			
			setTimeout(function(){
				$(f).fadeOut(0);
				f.style.backgroundImage = 'url(https://static1.fshare.vn/images/flies_die.png)';
				$(f).fadeIn();
			}, 1000);
			hasswatter = false;
			parent.stop();
			...
			if (Math.random() < 0.3) {
				f.style.cursor = 'url("https://static1.fshare.vn/images/flyswatter.png"), auto';
				hasswatter = true;				
			}
			setTimeout(function() {
				f.style.cursor = 'pointer';
...
$(document).click(function(e) {
	if (hasswatter){		
		...
		b.style.height = "96px";
		if (Math.random() < 0.5) {
			b.style.backgroundImage = "url(https://static1.fshare.vn/images/break-screen1.png)";
		} else {
			b.style.backgroundImage = "url(https://static1.fshare.vn/images/break-screen2.png)";
		}	
		...
		$('html').css('cursor','url("https://static1.fshare.vn/images/flyswatter2.png"), default');		
		setTimeout(function() {
			if (hasswatter){
				$('html').css('cursor','url("https://static1.fshare.vn/images/flyswatter.png"), default');
			} else {
